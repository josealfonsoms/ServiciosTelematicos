...
# Datos de servidores
bankTCP_address = ("127.0.0.1", 9000)               # Dirección y puerto TCP del servidor Bank

liquorStoreUDP_address = ("127.0.0.1", 4000)       # Dirección y puerto UDP del servidor LiquorStore
